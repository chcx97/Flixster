...
private const val YOUTUBE_API_KEY = "AIzaSyCYngIsK_qq-wPlDJqJqm_Xq0rN1peTzqE"
...
class DetailActivity : YouTubeBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val movie = intent.getParcelableExtra<Movie>(MOVIE_EXTRA) as Movie    //this casts the value as a non-nullable movie
